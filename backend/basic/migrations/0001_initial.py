# Generated by Django 3.1.4 on 2021-01-22 15:05
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('public_key', models.CharField(blank=True, max_length=1000)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('updated_at', models.DateTimeField(auto_now=True, null=True)),
                ('event', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, to='basic.event')),
                ('participant_personal', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, to='basic.participantpersonal')),
                ('role', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, to='basic.role')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.AddField(
            ...
            name='registration',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, to='basic.registration'),
        ),
        migrations.AddField(
            model_name='participantpersonal',
            name='scout_group',
